...
import user.app.fooddeliverywala.activity.PaymentActivity.Companion.hideProgressDialog
import user.app.fooddeliverywala.activity.PaymentActivity.Companion.showProgressDialog
import user.app.fooddeliverywala.adapter.OfferAdapter
import user.app.fooddeliverywala.model.OfferImages
                ...
                val stringRequest: StringRequest = object : StringRequest(
                    ...
                    override fun getHeaders(): MutableMap<String, String> {
                        ...
                        params1[Constant.AUTHORIZATION] =
                            "Bearer " + createJWT("ecart", "eKart Authentication")
                        return params1
                    }
