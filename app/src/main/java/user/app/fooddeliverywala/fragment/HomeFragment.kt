...
import user.app.fooddeliverywala.adapter.CategoryAdapter
import user.app.fooddeliverywala.adapter.OfferAdapter
import user.app.fooddeliverywala.adapter.SectionAdapter
...
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getOfferImage
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getSettings
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getWalletBalance
...
import user.app.fooddeliverywala.model.Category
import user.app.fooddeliverywala.model.Section
import user.app.fooddeliverywala.model.Slider
import java.util.*
    ...
    private fun getHomeData() {
        ...
        requestToVolley(object : VolleyCallback {
            override fun onSuccess(result: Boolean, response: String) {
                Log.wtf("onSuccess", "onSuccess: $response result $result", )
                if (result) {
                    try {
