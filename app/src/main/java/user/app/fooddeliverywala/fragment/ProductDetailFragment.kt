package user.app.fooddeliverywala.fragment
...
import user.app.fooddeliverywala.R
import user.app.fooddeliverywala.activity.MainActivity
import user.app.fooddeliverywala.adapter.AdapterStyle1
import user.app.fooddeliverywala.adapter.ProductLoadMoreAdapter
import user.app.fooddeliverywala.adapter.ReviewAdapter
import user.app.fooddeliverywala.adapter.SliderAdapter
import user.app.fooddeliverywala.helper.ApiConfig.Companion.addMarkers
import user.app.fooddeliverywala.helper.ApiConfig.Companion.addMultipleProductInCart
import user.app.fooddeliverywala.helper.ApiConfig.Companion.addOrRemoveFavorite
import user.app.fooddeliverywala.helper.ApiConfig.Companion.buildCounterDrawable
import user.app.fooddeliverywala.helper.ApiConfig.Companion.calculateDays
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getCartItemCount
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getDiscount
import user.app.fooddeliverywala.helper.ApiConfig.Companion.getSettings
import user.app.fooddeliverywala.helper.ApiConfig.Companion.isConnected
import user.app.fooddeliverywala.helper.ApiConfig.Companion.requestToVolley
import user.app.fooddeliverywala.helper.ApiConfig.Companion.stringFormat
import user.app.fooddeliverywala.helper.ApiConfig.Companion.toTitleCase
import user.app.fooddeliverywala.helper.Constant
import user.app.fooddeliverywala.helper.DatabaseHelper
import user.app.fooddeliverywala.helper.Session
import user.app.fooddeliverywala.helper.Utils.setFormatTime
import user.app.fooddeliverywala.helper.VolleyCallback
import user.app.fooddeliverywala.model.*
